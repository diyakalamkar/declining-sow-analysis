import pandas as pd
txn = pd.read_parquet("data/processed/transactions_clean.parquet")  # or re-load via your loader
# if you didn't save this parquet, just re-run clean_transactions() and use txn_clean directly
...
# B) Where did the diverted spend go? Check non-ABC payment methods same period at XYZ Inc
...
# C) Is it broad-based (most customers dropped a little) or a subset (some customers stopped using ABC card entirely)?
